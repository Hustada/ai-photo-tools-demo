...
const PhotoModal: React.FC<PhotoModalProps> = ({
  ...
  return (
    ...
    >
      <div 
        className="relative w-full h-full sm:h-[95vh] sm:max-w-[98vw] flex flex-col sm:flex-row overflow-hidden bg-black sm:rounded-xl shadow-2xl animate-slideUp"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Floating Header */}
        <div className="absolute top-0 left-0 right-0 z-20 flex justify-between items-center p-3 sm:p-4 bg-gradient-to-b from-black/60 to-transparent">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="hidden lg:flex items-center gap-1.5 text-white/50 text-xs">
              <span>Use</span>
              <kbd className="px-1 py-0.5 bg-white/10 rounded border border-white/20 text-white/70 text-[10px]">←</kbd>
              <kbd className="px-1 py-0.5 bg-white/10 rounded border border-white/20 text-white/70 text-[10px]">→</kbd>
        ...
        <div className="relative flex-1 sm:flex-[3] bg-black flex items-center justify-center group overflow-hidden">
          {/* Loading State */}
          {imageLoading && (
        ...
        <div className="w-full sm:w-[340px] bg-white sm:bg-gray-50 h-auto sm:h-full overflow-hidden flex flex-col animate-slideInRight">
